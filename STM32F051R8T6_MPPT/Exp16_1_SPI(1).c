/* ============================================================================ */
/*	Exp16_1_SPI(1).c : 16비트 SPI 전송 포맷을 사용한 터치 스크린 입력	*/
/* ============================================================================ */
...
void Initialize_SPI1_16bit(void);		/* initialize touch screen using 16-bit SPI1 */
unsigned short Read_ADS7846_16bit(U16 command);	/* read X, Y value from ADS7846 using 16-bit SPI1 */
...
int main(void)
{
  ...
  Initialize_SPI1_16bit();			// initialize touch screen using 16-bit SPI1
...
void Initialize_SPI1_16bit(void)		/* initialize touch screen using 16-bit SPI1 */
{
  ...
  Read_ADS7846_16bit(ADS7846_CMD_X);		// dummy input for -TS_INT signal
}
