...
int main(void)
{
  ...
  DAC->CR = 0x00000001;				// DAC enable, output buffer and trigger disable
  DAC->DHR12R1 = 0;				// clear output data
...
void Draw_organ(void)				/* draw organ screen */
{
  ...
  TFT_string(1, 1,White,Magenta," OK-STM32F7 키트를 이용한 전자 오르간 "); // display title
