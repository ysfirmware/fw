...
//Ô“???IC„¿ILI9320?„¿ILI9325
#define  ILI9325 
 
//?ÿ≠‡¡?Ô“? ?ÌÆ‰ŒŒ ID[1:0]AM ‰ŒŒPDFÒÈÓ‹€’ˆ«Ô“?
#define ID_AM  110
 
//?ÿ≠?„∑??„∆€∞„“£¨ÒºÎÚ£∫?IDelay??„∆ØÏÈ¯Î?ÿ¸„¿ıÔﬂ¿·»·Ï„ÊÓ‹
//ÛÆ?˘±?‚¢?Ó§·Ï„Ê?·÷˝® •ﬂæ  LCD_WR_REG(0x0007,0x0173);Ó¶“ˆ?„∆
//?Immediately??ÍÛ˘¨Òº?”¸„¿‹Ù‚ÕÈ©ÛÆ?ÔÔ
...
#define nCsPin  GPIO_Pin_12
#define RsPin   GPIO_Pin_14
#define nWrPin  GPIO_Pin_13
#define nRdPin  GPIO_Pin_15
#define nRstPin GPIO_Pin_11
#define Lcd_LightPin GPIO_Pin_0
 
#define Set_nWr (*((volatile unsigned long *) 0x40011410) = nWrPin)
#define Clr_nWr (*((volatile unsigned long *) 0x40011414) = nWrPin)
 
#define Set_Cs  (*((volatile unsigned long *) 0x40011410) = nCsPin)
#define Clr_Cs  (*((volatile unsigned long *) 0x40011414) = nCsPin)
...
#define Set_Rst (*((volatile unsigned long *) 0x40011410) = nRstPin)
#define Clr_Rst (*((volatile unsigned long *) 0x40011414) = nRstPin)
