...
void Initialize_SPI2_16bit(void)		/* initialize touch screen using 16-bit SPI1 */
{
...
void Input_touch_screen(void)			/* touch screen input of X, Y average value from ADS7846 */
{
  unsigned char i;
  unsigned short temp;
