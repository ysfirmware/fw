;[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
;[]								   []
;[]	Exp12_2.asm : RS-232C Communication using USART1	   []
;[]								   []
;[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
;
...
;------------------------------------------------
CK_RXD:	CALL	RX1_SCAN		; check if a character was received
...
;------------------------------------------------
;	Receive a Character(RXD_BUFFER) by USART1
;------------------------------------------------
RX1_CHAR:PUSH	AL

RX1_CHAR1:LDS	AL,UCSR1A		; data received ?
	SBRS	AL,RXC1
	RJMP	RX1_CHAR1
	LDS	RXD_BUFFER,UDR1
...
;------------------------------------------------
;	Receive a Character without wait by USART1
;------------------------------------------------
RX1_SCAN:PUSH	AL

	LDS	AL,UCSR1A		; data received ?
	SBRS	AL,RXC1
	RJMP	RX1_SCAN1
	LDS	RXD_BUFFER,UDR1		; if yes, receive and C=0
	CLC
	RJMP	RX1_SCAN2
RX1_SCAN1:SEC				; if no, C=1
