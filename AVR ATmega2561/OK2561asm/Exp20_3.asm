;[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
;[]                                                                []
;[]	     Exp20_3.asm : Watchdog Timer - Interrupt Mode	   []
;[]                                                                []
;[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
;
...
.cseg
	.org	0x0000
	JMP	RESET			; reset entry point

	.org	0x0018
	JMP	WDT			; interrupt vector WDT
...
CK_KEY3:CPI	AL,0b10110000		; if KEY3, enable Watchdog Timer
	BRNE	NO_KEY
	LDI	AL,(1<<WDCE) | (1<<WDE)
	STS	WDTCSR,AL		;  (interrupt mode, 0.25 sec)
	LDI	AL,(1<<WDIE) | (1<<WDP2)
	STS	WDTCSR,AL
	LDI	AL,0b01000000		; LED3 = on
	OUT	PORTB,AL
	SEI
...
;====================================================================
;	Interrupt Service Routine of WDT
;====================================================================
WDT:	CALL	BEEP
	RETI
